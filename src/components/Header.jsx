                    ...
                    <Menu as="div" className="ml-3 relative">
                      <div>
                        <Menu.Button className="max-w-xs bg-gray-800 rounded-full flex items-center text-sm focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white">
                          ...
                          <Image className="h-8 w-8 rounded-full" src={userData.imageUrl} alt="User" width="32" height="32" />
                        </Menu.Button>
                      </div>
                      <Transition
                        as={Fragment}
                      ...
                      >
                        <Menu.Items className="origin-top-right absolute right-0 mt-2 w-48 rounded-md shadow-lg py-1 bg-white ring-1 ring-black ring-opacity-5 focus:outline-none">
                          <Menu.Item>
                            <button onClick={() => auth.logout()} type="button" className="block px-4 py-2 text-sm text-gray-700">
                              Logout
                            </button>
                          </Menu.Item>
                        </Menu.Items>
            ...
            <Disclosure.Panel className="md:hidden">
              ...
              <div className="pt-4 pb-3 border-t border-gray-700">
                <div className="flex items-center px-5">
                  <div className="flex-shrink-0">
                    <Image className="h-10 w-10 rounded-full" src={userData.imageUrl} alt="User Data" width="40" height="40" />
                  </div>
                  <div className="ml-3">
