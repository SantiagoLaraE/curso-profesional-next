      ...
      <div className="hidden sm:flex sm:flex-1 sm:items-center sm:justify-between">
        <div>
          <p className="text-sm text-gray-700">
            Showing <span className="font-medium">{productOffset + 1}</span> to <span className="font-medium">{productOffset + productLimit > totalProducts ? totalProducts : productOffset + productLimit }</span> of{' '}
